...
STIM_bloks = 2 # Number of repetitions of the bloks
STIM_break = int(30 * MON_frame_rate) # Break between bloks (30 sec)
STIM_rep = 2
...
imageFolderPathAni = 'C:/Users/slmoni/Documents/Uni/Introduction to Neuroscience/Neuroimaging studie/Images/Ani' #Loading images from the Ain folder (animate)
STIMANI0 = glob.glob(imageFolderPathAni + '/*.JPG') 
...
imageFolderPathInani = 'C:/Users/slmoni/Documents/Uni/Introduction to Neuroscience/Neuroimaging studie/Images/Inani' #Loading images from the Inain folder (inanimate)
STIMINANI0 = glob.glob(imageFolderPathInani + '/*.JPG')

imageFolderPathInani = 'C:/Users/slmoni/Documents/Uni/Introduction to Neuroscience/Neuroimaging studie/Images/Inani2' #Loading images from the Inain2 folder (inanimate)
STIMINANI1 = glob.glob(imageFolderPathInani + '/*.JPG')
...
message = visual.TextStim(win, pos =[0,0], text = introText, height = 0.75, alignHoriz = 'center') # create an instruction text
...
message = visual.TextStim(win, pos =[0,0], text = outroText, height = 0.75, alignHoriz = 'center') # create an instruction text
message.draw() # draw the text stimulus in a "hidden screen" so that it is ready to be presented # flip the screen to reveal the stimulus
win.flip()
event.waitKeys()
